...
\begin{thm}
Suppose $(S,d_S)$ is a metric space and $f: S\rightarrow R$ is a function (to Euclidean space).\\
...
\begin{thm}
If $I\subseteq \mathbb{R}$ is an interval, then there does not exist two nonempty open sets $U,V\subseteq\mathbb{R}$ (Euclidean space), with
$$I\subseteq U\cup V.$$
\end{thm}
\end{frame}
...
\begin{itemize}
\pause
\item the real line with the Euclidean metric $(\mathbb{R},d_{disc})$ is connected
\pause
