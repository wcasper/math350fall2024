...
\section{Real Analysis Lecture 21}
...
\pause
A \textbf{Riemann-Stieltjes sum} is a sum of the form
...
\pause
Take a partition $P = \{x_0,\dots,x_n\}$ of $[0,1]$, sample points $\{t_k\}$:
...
\pause
\hfil {\color{red}Where do you go from here?}
\end{frame}
