...
Prove that if $f: S\rightarrow \mathbb{R}$ and $g: S\rightarrow\mathbb{R}$ are continuous at $a\in S$, then so is $f + g$.
\end{frame}

\begin{frame}{Warm-up}
Let $(S,d)$ be a metric space.
Prove that if $f: S\rightarrow \mathbb{R}$ and $g: S\rightarrow\mathbb{R}$ are continuous at $a\in S$, then so is $fg$.
\end{frame}

\begin{frame}{Warm-up}
Let $(S,d)$ be a metric space.
Prove that if $f: S\rightarrow \mathbb{R}$ and $g: S\rightarrow\mathbb{R}$ are continuous at $a\in S$ with $g(a)\neq 0$, then so is $f/g$.
\end{frame}
